...
CREATE TABLE PONTE_AEREA (
  ID_PONTE_AEREA INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE AEROPORTO (
  ...
  PONTE_AEREA_ID_PONTE_AEREA INTEGER UNSIGNED NOT NULL,
...
ALTER TABLE voo ADD CONSTRAINT FOREIGN KEY(PONTE_AEREA_ID_PONTE_AEREA)
...
ALTER TABLE aeropoto ADD CONSTRAINT  FOREIGN KEY(PONTE_AEREA_ID_PONTE_AEREA)
    REFERENCES PONTE_AEREA(ID_PONTE_AEREA)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION;
...
ALTER TABLE venda ADD CONSTRAINT  fk_venda_ponte FOREIGN KEY(PONTE_AEREA_ID_PONTE_AEREA)
    REFERENCES PONTE_AEREA(ID_PONTE_AEREA)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION;
/***************************************************************************
